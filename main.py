...
# Setting page configuration for Streamlit application
icon = Image.open("G:\\Arun\\DS23\\DS\\capstone\\bizcardx\\OCR.png")
...
def bg_set():
    st.markdown(f""" <style>.stApp {{
                        background: 
                        url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxzHoX-q-RA44TubOI5RhRX96NQgPvBV4yIMhaowcfEdPscW44HT0InNb0C5R6vCHPTzk&usqp=CAU");
...
if selected == "Home":
    ...
    with col1:
        image = Image.open("G:\\Arun\\DS23\\DS\\capstone\\bizcardx\\OCR.png")
        st.image(image)
    with col2:
        st.markdown(
            "### <span style='color: blue;'>Overview:</span> The project involves developing a Streamlit application "
            "using Python, easyOCR, and a database management system. "
            "Users can upload business card images, extract information using OCR, and store it in a database. "
            "The application features a user-friendly interface, image processing, and database integration. "
            "It aims to provide efficient management of business card data.", unsafe_allow_html=True)
